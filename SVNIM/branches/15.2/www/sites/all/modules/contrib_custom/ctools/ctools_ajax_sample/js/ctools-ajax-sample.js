...
/***** ***********************************
 ******** HTML for new style popup
 ****************************************/
Drupal.theme.prototype.IntranetPopup = function () {
	  var html = '';
	  html += '<div id="ctools-modal" class="popups-box">';
	  html += '<span class="im-popups-close"><a class="close" href="#"></a></span>';
	  html += '  <div class="ctools-modal-content ctools-sample-modal-content im-popup-content">';
	  html += '          <div class="popups-container">';
	  html += '              <div class="clear-block"></div>';
	  html += '            <div class="modal-scroll"><div id="modal-content" class="modal-content popups-body"></div></div>';
	  html += '            <div class="popups-buttons"></div>'; //Maybe someday add the option for some specific buttons.
 ...
 ******** HTML for new style popup
 ****************************************/
Drupal.theme.prototype.ProfilePopup = function () {
	  var html = '';
	  html += '<div id="ctools-modal" class="popups-box">';
	  html += '<span class="im-popups-close"><a class="close" href="#"></a></span>';
	  html += '  <div class="ctools-modal-content ctools-sample-modal-content im-profile-popup">';
	  html += '          <div class="popups-container">';
	  html += '              <div class="clear-block"></div>';
	  html += '            <div class="modal-scroll"><div id="modal-content" class="modal-content popups-body"></div></div>';
	  html += '            <div class="popups-buttons"></div>'; //Maybe someday add the option for some specific buttons.
