      ...
      <div id="content-column" class="content-column" role="main">
        <div class="content-inner">
		  ...
		  if ($messages) {
			  ...
			  if (!empty($_POST['field_om_subdomain_custom'])) {
			    drupal_add_js(array('dynamic_subdomain_default_value'=>$_POST['field_om_subdomain_custom']), 'setting');
			  }
			  else {
			     drupal_add_js(array('dynamic_subdomain_default_value'=>''), 'setting');
			  }
			  
			  if (!empty($_POST['field_om_macro_activity_custom'])) {
			    drupal_add_js(array('dynamic_macro_default_value'=>$_POST['field_om_macro_activity_custom']), 'setting');
			  }
			  else {
			     drupal_add_js(array('dynamic_macro_default_value'=>''), 'setting');
			  }
		  }
		  drupal_add_js('jQuery(document).ready(function () { jQuery(".enabled-for-ajax-domain-custom").trigger("change"); });', 'inline');
		  print $messages; ?>
