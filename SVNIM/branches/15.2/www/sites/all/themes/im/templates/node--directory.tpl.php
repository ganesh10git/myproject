 ...
 */
?><?php if(!empty($dir_content['user_name'])){?>
<div class = "directory-content" id ="node-<?php if (isset($dir_content['nid'])) { print $dir_content['nid']; }?>">
  <div class = "directory-function"><?php if (isset($dir_content['fn_name'])) { print $dir_content['fn_name']; }?></div>
  <div class = "directory-user-img"><?php if (isset($dir_content['user_img'])) { print theme ('image', $dir_content['user_img']); } ?></div>
  <div class= "directory-detial-sec">
	  <div class = "directory-user-name"><?php if (isset($dir_content['user_name'])) { print $dir_content['user_name']; }?></div>
	  <div class = "directory-user-mail"><?php if (isset($dir_content['user_mail'])) { print $dir_content['user_mail']; }?></div>

<?php if (!empty($dir_content['telephoneNumber'])) {?>
	 <div class = "directory-user-bureau"><span>Bureau</span><?php  print $dir_content['telephoneNumber'];?> </div> <?php }?>
	 <?php if (!empty($dir_content['mobile'])) {?>
	  <div class = "directory-user-mobile"><span>Mobile</span><?php  print $dir_content['mobile'];?></div> <?php }?>
