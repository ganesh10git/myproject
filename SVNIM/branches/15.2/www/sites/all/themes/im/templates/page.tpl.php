...
<div id="page" class="container <?php print $classes; ?>">
  ...
  <div id="columns" class="columns clearfix">
    ...
    <?php if ($title && !$is_front && $_GET['q'] != 'sales-plan/now/all' && !strstr($_GET['q'], 'modele-operationnel') ): ?>
        <h1 id="page-title">
          <?php print $title; ?>
        </h1>
    <?php endif; ?>
  ...
  <?php
	if ($messages) {
	  if (isset($_POST['field_om_experts']['und'])) {
		  foreach ($_POST['field_om_experts']['und'] as $key=>$values){
			$expert_options[$values] = $values;
		  }
  ...
  <div class="go_top_link">
<?php if(arg(0) == 'agenda' && arg(1)=='list'){?><a href = "#top" >Haut de page</a><?php }?></div>
  <!-- region: Footer -->
  <?php if ($page['footer']): ?>
...
<!-- cuwa -->
<?php //print $cuwa_xtsd.'<br>';print $cuwa_xtsite.'<br>';print $cuwa_mode.'<br>';print $cuwa_xtpage.'<br>';print $cuwa_xt_an.'<br>'; exit;?>
<?php if (isset($cuwa_xtsd) && isset($cuwa_xtsite) && isset($cuwa_xtpage) && isset($cuwa_xtn2) && isset($cuwa_xt_an)): ?>
<noscript>
<div>
  <img width="1" height="1" alt="" src="<?php print $cuwa_xtsd; ?>.xiti.com/hit.xiti?s=<?php print $cuwa_xtsite;?>&s2=<?php print $cuwa_xtn2; ?>&p=<?php print $cuwa_xtpage; ?>&di=&an=<?php print $cuwa_xt_an; ?>&ac=" />
</div>
</noscript>
<?php endif; ?>
<!-- /#cuwa -->